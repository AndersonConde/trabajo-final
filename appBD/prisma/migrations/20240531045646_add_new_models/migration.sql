...
INSERT INTO "new_Cotizacion" ("cliente", "fecha_cotizacion", "id", "precio_cotizado", "userId", "vehiculo", "vendedor") SELECT "cliente", "fecha_cotizacion", "id", "precio_cotizado", "userId", "vehiculo", "vendedor" FROM "Cotizacion";
